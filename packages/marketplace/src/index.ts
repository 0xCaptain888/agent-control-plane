...
export function sampleAgents(): AgentProfile[] {
  return [
    ...
    { id: "rebalance-guard", name: "RebalanceGuard Agent", category: "rebalancing", description: "Proposes risk-bounded BNB portfolio rebalancing with exposure and turnover limits.", chain: "bnb-testnet", identityId: "reference:erc8004:bnb-testnet:rebalance-guard", operatorAddress: "0x0000000000000000000000000000000000000000", endpoint: "https://demo.agentguard.local/agents/rebalance-guard", capabilities: ["allocation_drift", "turnover_limit", "rebalance_proposal"], supportedAssets: ["BNB", "USDT", "USDC"], pricingModel: "per-task", priceUSDT: "0.35", successRate: 0.93, averageLatencyMs: 14000, reputationScore: 0.91, evidence: [{ label: "Reference benchmark", uri: "report://bnb/rebalancing/001", kind: "report" }], availability: "reference", dataSource: "reference-harness", lastActivity: "Reference benchmark only", policyBoundary: "10% max drift · 15% max turnover · approval before execution" },
    { id: "yield-scout", name: "YieldScout Agent", category: "yield-optimisation", description: "Compares BNB Chain yield opportunities and proposes risk-bounded allocation changes.", chain: "bnb-testnet", identityId: "reference:erc8004:bnb-testnet:yield-scout", operatorAddress: "0x0000000000000000000000000000000000000000", endpoint: "https://demo.agentguard.local/agents/yield-scout", capabilities: ["yield_comparison", "apy_delta_analysis", "allocation_guard"], supportedAssets: ["BNB", "USDT"], pricingModel: "per-task", priceUSDT: "0.40", successRate: 0.89, averageLatencyMs: 26000, reputationScore: 0.88, evidence: [{ label: "Reference benchmark", uri: "report://bnb/yield-optimisation/001", kind: "report" }], availability: "reference", dataSource: "reference-harness", lastActivity: "Reference benchmark only", policyBoundary: "APY delta required · exposure cap · human approval before rebalance" },
    { id: "health-guard", name: "HealthGuard Agent", category: "health-factor-monitoring", description: "Monitors lending health factors and proposes bounded protection actions before liquidation risk increases.", chain: "bnb-testnet", identityId: "reference:erc8004:bnb-testnet:health-guard", operatorAddress: "0x0000000000000000000000000000000000000000", endpoint: "https://demo.agentguard.local/agents/health-guard", capabilities: ["health_factor_monitoring", "liquidation_alerts", "bounded_repay"], supportedAssets: ["BNB", "USDT", "USDC"], pricingModel: "per-task", priceUSDT: "0.25", successRate: 0.93, averageLatencyMs: 9000, reputationScore: 0.91, evidence: [{ label: "Reference benchmark", uri: "report://bnb/health-factor/001", kind: "report" }], availability: "reference", dataSource: "reference-harness", lastActivity: "Reference benchmark only", policyBoundary: "alert below 1.35 · repay cap · no unsanctioned collateral movement" }
  ];
}
