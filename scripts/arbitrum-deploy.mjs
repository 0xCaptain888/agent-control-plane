...
const sourcePath = resolve(root, "contracts/arbitrum/PolicyEscrowV2.sol");
const deploymentPath = resolve(root, "deployments/arbitrum-sepolia-policy-escrow-v2.json");
...
const input = {
  language: "Solidity",
  sources: { "PolicyEscrowV2.sol": { content: readFileSync(sourcePath, "utf8") } },
...
const compiled = output.contracts["PolicyEscrowV2.sol"].PolicyEscrowV2;
